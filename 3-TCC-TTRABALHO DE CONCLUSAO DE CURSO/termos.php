...
<body>
    ...
    <div class="container">
    <h3>VISÃO GERAL</h3>
    <p>Esse site é operado pelo Pigmeu Store. Em todo o site, os termos “nós”, “nos” e “nosso” se referem ao Pigmeu Store. O Pigmeu Store proporciona esse site, incluindo todas as informações, ferramentas e serviços disponíveis deste site para você, o usuário, com a condição da sua aceitação de todos os termos, condições, políticas e avisos declarados aqui.</p>
    ...
    <h3>SEÇÃO 5 - PRODUTOS OU SERVIÇOS</h3>

    <p>Certos produtos ou serviços podem estar disponíveis exclusivamente online através do site. Tais produtos ou serviços podem ter quantidades limitadas e são sujeitos a apenas devolução ou troca, de acordo com nossa <a href="devolucao.php">Política de devolução</a>.</p>
    ...
    <p>Para mais detalhes, por favor, revise nossa <a href="devolucao.php">Política de devolução</a>.</p>
    ...
    <p>O envio de suas informações pessoais através da loja é regido pela nossa <a href="privacidade.php">Política de privacidade</a>.</p>
    ...
    <p>Esses Termos de serviço e quaisquer acordos separados em que nós lhe fornecemos os Serviços devem ser regidos e interpretados de acordo com as leis de São Paulo, SP, Brasil.</p>
    ...
    <p>As perguntas sobre os Termos de serviço devem ser enviadas para nós através do e-mail xxxxx</p>
